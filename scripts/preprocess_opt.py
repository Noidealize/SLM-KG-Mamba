...
import torch
from models.Preprocess_Opt_1b import Model
...
if __name__ == '__main__':
    ...
    parser.add_argument('--llm_ckp_dir', type=str, default='facebook/opt-1.3b', help='llm checkpoints dir or Hugging Face repo id')
